            ...
            <ol class="property-list user">
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="thumbnail-label">
                        <img src = "${grailsApplication.config.myconf.assets_url}${user.thumbnail.filename}" width="50" height="50"/>
                    </div>
                </li>
                <li class="fieldcontain">
                ...
                <li class="fieldcontain">
                    <div><g:link controller="annonce" action="create" params="['userId':user.id]">Add Annonce</g:link></div>
                </li>
            </ol>

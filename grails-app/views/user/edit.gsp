...
<html>
    ...
    <body>
        ...
        <div id="edit-user" class="content scaffold-edit" role="main">
            ...
            <g:form enctype="multipart/form-data" resource="${this.user}" method="POST" >
                <fieldset class="form">
                    ...
                    <div class="fieldcontain required">
                        <label>Old Thumbnail
                            <span class="required-indicator">*</span>
                        </label><g:img file="${user.thumbnail.filename}" width="50" height="50"/>
                    </div>

                    <div class="fieldcontain required">
                        <label for="thumbnail">Add new thumbnail
                            <span class="required-indicator">*</span>
                        </label><input type="file" name="file" id="thumbnail">
                    </div>
                    <div class="fieldcontain">
                        <label for="${user.id}">Annonces</label>
                        <ul>
